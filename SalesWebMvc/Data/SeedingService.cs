...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "b_brown@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "m_green@gmail.com", new DateTime(1979, 3, 14), 2000.0, d4);
            Seller s3 = new Seller(3, "Alex Grey", "a_grey@gmail.com", new DateTime(1985, 7, 30), 3500.0, d2);
            Seller s4 = new Seller(4, "Marta Purple", "m_purple@gmail.com", new DateTime(1978, 2, 7), 4300.0, d3);
            Seller s5 = new Seller(5, "Chris White", "c_white@gmail.com", new DateTime(1993, 12, 16), 1400.0, d1);
            Seller s6 = new Seller(6, "Alice Thompson", "a_thompson@gmail.com", new DateTime(1987, 4, 2), 2400.0, d2);
